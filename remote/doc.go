...
// the remote package mainly uses the hyperledger contract class and the got datastructures
// the got datastructures inner package provides the necessary data modeling and validation.
package remote
